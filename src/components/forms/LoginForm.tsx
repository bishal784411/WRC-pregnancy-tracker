...
//   const { login, verifyEmail, loading, toast, hideToast, showToast } = useAuth();
...
//       <form onSubmit={handleSubmit} className="space-y-6 font-nunito font-nunito font-semibold relative z-10 transition-all duration-500">
//         <Input
//           label="Email Address"
//           type="email"
//           value={email}
